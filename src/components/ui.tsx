      ...
      {[1, 2, 3, 4, 5].map(i => {
        ...
        return (
          <svg key={i} width={size} height={size} viewBox="0 0 24 24" aria-hidden>
            <path
              d={STAR_PATH}
              fill={on ? '#FBBF24' : 'rgba(255,255,255,0.12)'}
...
/** Interactive star picker — gold fill clearly highlights selected rating. */
        ...
        return (
          ...
          >
            <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden>
              <path
                d={STAR_PATH}
                fill={on ? '#FBBF24' : 'rgba(255,255,255,0.08)'}
                stroke={on ? '#F59E0B' : 'rgba(255,255,255,0.4)'}
                strokeWidth={1.4}
                strokeLinejoin="round"
              />
            </svg>
