          ...
          <InfoPanel className="mb-4">
            ...
            {user.gps_lat && user.gps_lng ? (
              <div className="space-y-1">
                ...
                <a href={mapUrl!} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 rounded-xl px-3 py-2 text-sm font-bold" style={{ background: pg.limeDim, border: `1px solid rgba(212,240,0,0.28)`, color: pg.lime }}>
